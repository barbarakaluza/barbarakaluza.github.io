...
fetch('https://api.github.com/users/barbarakaluza/repos?sort=created&direction=asc')
.then((res) => res.json())
.then((res) => {
    const container = document.querySelector('.project__github-grid--js');
    for (let repo of res) {
        const {description, homepage, html_url, name} = repo;
        const template = `<div class="github" id="github" >
        <div class="github__gap">
          <div class="github__circles">
        ...
        <article class="github__project">
          <h3 class="project__title">
            <span class="project__field">project: </span>
            <span class="project__value--bold">${name}</span>
          </h3>
          <p class="project__paragraf">
            <span class="project__field">description:</span>
            <span class="project__value"
              >${description}</span
            >
          </p>
          <p class="project__paragraf">
            <span class="project__field">demo:</span>
            <span class="project__lt">
          ...
          <p class="project__paragraf">
            <span class="project__field">github:</span>
            <span class="project__lt">
